...
- [Here on Github](https://github.com/Pagnet/ocean-icons/issues) (public :heart_eyes:)
...
- [Good first issues](https://github.com/Pagnet/ocean-icons/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22+sort%3Acomments-desc) - issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/Pagnet/ocean-icons/issues?q=is%3Aopen+is%3Aissue+sort%3Acomments-desc+label%3A%22help+wanted%22) - issues which should be a bit more involved than beginner issues.
...
```bash
git clone https://github.com/Pagnet/ocean-icons.git # bonus: use your own fork for this step
cd ocean-icons
